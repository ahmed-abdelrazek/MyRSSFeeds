...
namespace MyRSSFeeds.WinUI.Extensions
{
    ...
    public static class SettingsStorageExtensions
    {
        ...
        {
            return Task.FromResult(settings.Values.TryGetValue(key, out object obj) ? JsonSerializer.Deserialize<T>((string)obj) : default(T));
        }
        ...
        {
            return string.Concat(name, _fileExtension);
        }
    }
}
